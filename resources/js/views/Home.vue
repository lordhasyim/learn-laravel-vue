<template>
    <div>
        <div class = "container-fluid hero-section d-flex align-content-center flex-wrap ml-auto">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-4 product-box" v-for="(product, index) in products" @key="index" >
                            <router-link :to="{ path: '/products/'+product_id}">
                                <img :src="product.image" :alt="product.name">
                                <h5>
                                    <span class="small-text text-muted float-rigt">${{product.price}}</span>
                                </h5>
