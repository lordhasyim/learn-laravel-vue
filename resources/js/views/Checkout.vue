        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="order-box">
                    ...
                    <p class="small-text float-left">$ {{product.price}}</p>
                    ...
                    <label class="row">
                        ...
                        <input type="number" name="units" min="1"
                            :max="product.units" class="col-md-2 float-left" v-model="quantity" @change="checkUnits" >
                    </label>
                </div>
                <br>
                <div>
                    <div v-if="!isLoggedIn">
                        <h2>You need login to continue</h2>
                        <button class="col-md-4 btn btn-primary float-left" @click="login" >Login</button>
                        <button class="col-md-4 btn btn-danger float-left" @click="register" >Create an account</button>
                    </div>
                    <div v-if="isLoggedIn" >
